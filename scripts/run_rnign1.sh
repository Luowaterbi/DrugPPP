...
lr_lst=(0.000297761742587349)
# lr_lst=(0.001)
# lr_lst=(0.001 0.003 0.0005)

train_batch_size_lst=(61)
...
warmup_proportion_lst=(0.028272727478942175)
...
enc_dropout_lst=(0.11215640166056916)
...
inter_dropout_lst=(0.05082303537993785)
