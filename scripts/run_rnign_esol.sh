                                            ...
                                            for num_used_experts in ${num_used_experts_lst[@]}; do
                                              for moe_loss_coef in ${moe_loss_coef_lst[@]}; do
                                                ...
                                                for moe in ${moe_lst[@]}; do
                                                  ...
                                                  model_name=rnign.readout_${readout}.bs_${train_batch_size}.ep_${epoch}.lr_${lr}.warmup_${warmup_proportion}.num_experts_${num_experts}.num_used_experts_${num_used_experts}.moe_loss_coef_${moe_loss_coef}.${debug}${compare}
